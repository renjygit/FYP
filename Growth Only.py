...
for time in timeArray:
    ...
    """
    growthRatePosArray.append(0)
    plt.plot(rBins, growthRatePosArray)
    plt.title("Growth rate pos against radius at time t = " + str(time))
    plt.show()
    """
